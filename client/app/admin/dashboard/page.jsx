...
import { Edit, Trash2, Search, ThumbsUp } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5FAF7] pb-20">
      {/* Header */}
      ...
      <div className="max-w-6xl mx-auto mb-10 px-4">
        <h2 className="font-bold text-xl text-green-700 mb-4 flex items-center gap-2">
          <ThumbsUp className="text-green-400" size={20} /> Top 3 Liked Posts
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {top3.map((blog) => (
            <motion.div
              key={blog._id}
              className="rounded-xl bg-white border border-green-100 shadow p-5 flex flex-col hover:shadow-lg transition"
            ...
            >
              ...
              <div className="text-xs text-green-600 flex items-center gap-1">
                <ThumbsUp size={16} /> {blog.likes} likes
              </div>
            </motion.div>
          ))}
        </div>
                      ...
                      {editId === blog._id ? (
                        ...
                        >
                          ...
                          <textarea
                            ...
                            onChange={handleEditChange}
                          />
                          {/* If you want to allow changing imageUrl: */}
                          {/* <input
                            className="border px-2 py-1 rounded"
                            name="imageUrl"
