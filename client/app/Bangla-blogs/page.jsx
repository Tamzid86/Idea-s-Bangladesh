...
export default function BanglaBlogs() {
    ...
    useEffect(() => {
        ...
        axios
            .get("http://localhost:5000/api/blogs/bangla")
            .then((res) => {
                setBlogs(res.data);
    ...
    function BlogCard({ blog, handleShowSummary }) {
        ...
        const handleLike = async () => {
            ...
            try {
                const res = await axios.post(`http://localhost:5000/api/blogs/bangla/${blog._id}/like`, {
                ...
                {commentModal && (
                    <div className="fixed inset-0 z-50 backdrop-blur-sm bg-white/30 flex items-center justify-center">
                        <div className="bg-white p-6 rounded-lg w-[90%] max-w-md shadow-xl relative">
                            ...
                            <h2 className="text-xl font-bold mb-4">মন্তব্যসমূহ</h2>
